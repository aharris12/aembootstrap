...
(function($CQ, _, Backbone, SCF) {
    ...
    SCF.registerComponent('AEMBootstrap/components/ideation/post', SCF.Post, SCF.PostView);
    SCF.registerComponent('AEMBootstrap/components/ideation/topic', SCF.Idea, SCF.IdeaView);
    SCF.registerComponent('AEMBootstrap/components/ideation/forum', SCF.Forum, SCF.ForumView);
})($CQ, _, Backbone, SCF);